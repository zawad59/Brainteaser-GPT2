...
log_csv_file = "phi1_5_training_logs.csv"
...
for lr in learning_rates:
    for wd in weight_decays:
        model_id = f"Phi1_5_lr{lr}_wd{wd}"

        # Define training arguments
        training_args = TrainingArguments(
            output_dir=f"./phi1_5_finetuned_lr{lr}_wd{wd}",
            num_train_epochs=5,
        ...
        model.save_pretrained(f"./phi1_5_finetuned_lr{lr}_wd{wd}")
