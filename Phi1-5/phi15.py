...
log_csv_file = "phi15_training_logs.csv"
...
for lr in learning_rates:
    for wd in weight_decays:
        model_id = f"phi15_lr{lr}_wd{wd}"
        save_dir = f"./phi15_lora_finetuned_lr{lr}_wd{wd}"
        ...
        trainer.save_model(f"./phi15_lora_finetuned_lr{lr}_wd{wd}")
